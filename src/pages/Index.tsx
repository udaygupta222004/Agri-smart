...
const Index = () => {
  ...
  const translations = {
    en: {
      aiPowered: '🌾 AI-Powered Agricultural Support for Indian Farmers',
    ...
    hi: {
      aiPowered: '🌾 भारतीय किसानों के लिए AI-संचालित कृषि सहायता',
    ...
    te: {
      aiPowered: '🌾 భారతీయ రైతుల కోసం AI-ఆధారిత వ్యవసాయ మద్దతు',
    ...
    ta: {
      aiPowered: '🌾 இந்திய விவசாயிகளுக்கான AI-இயங்கும் வேளாண் ஆதரவு',
